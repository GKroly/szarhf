...
/**
 * Class that can take keyboard events. To start keyboard listening invoke {@link #init()}.
 */
  ...
  private static final class WindowCloseListenerImpl implements Window.ClosingHandler {
    ...
    private native void init() /*-{
			$doc.onkeydown = function(evt) {
				@com.szar.gwt.connectors.client.listeners.Keyboard::onKeyDown(Lcom/google/gwt/user/client/Event;)(evt || $wnd.event);
			}

			$doc.onkeypress = function(evt) {
				@com.szar.gwt.connectors.client.listeners.Keyboard::onKeyPress(Lcom/google/gwt/user/client/Event;)(evt || $wnd.event);
			}

			$doc.onkeyup = function(evt) {
				@com.szar.gwt.connectors.client.listeners.Keyboard::onKeyUp(Lcom/google/gwt/user/client/Event;)(evt || $wnd.event);
			}
    }-*/;
