...
import com.szar.gwt.connectors.client.drag.AxisXYDragController;
import com.szar.gwt.connectors.client.elements.SectionDecoration.DecorationDirection;
  ...
  public void showOnDiagram(Diagram diagram, boolean isSelected, ConnectorStyle style) {
    ...
    this.sectionDragController.addDragHandler(new DragHandlerAdapter() {
      ...
      public void onDragStart(DragStartEvent event) {
        ...
        connector.diagram.onElementDrag(new com.szar.gwt.connectors.client.listeners.event.ElementDragEvent(event
            .getContext().draggable, startX, startY,
            com.szar.gwt.connectors.client.listeners.event.ElementDragEvent.DragEventType.DRAG_START));
        Section.this.connector.select();
      }
