package com.szar.gwt.connectors.client;
...
import com.szar.gwt.connectors.client.drag.EndPointDragController;
import com.szar.gwt.connectors.client.drag.ShapePickupDragController;
...
import com.szar.gwt.connectors.client.listeners.DiagramListener;
import com.szar.gwt.connectors.client.listeners.DiagramModeListener;
import com.szar.gwt.connectors.client.listeners.Keyboard;
import com.szar.gwt.connectors.client.listeners.KeyboardListener;
import com.szar.gwt.connectors.client.listeners.event.DiagramAddEvent;
import com.szar.gwt.connectors.client.listeners.event.DiagramEvent;
...
//  }
  ...
  public void onElementDrag(com.szar.gwt.connectors.client.listeners.event.ElementDragEvent event) {
    if (isEnableEvents()) {
      for (DiagramListener listener : listeners) {
  ...
  public void setSelectionMode(boolean mode) {
	...
	public void onMouseDown(MouseDownEvent event) {
        ...
        if (!selectionMode) {
          ...
          for (com.szar.gwt.connectors.client.elements.Shape shape : shapes) {
